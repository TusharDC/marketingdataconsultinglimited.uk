          ...
          <div className="">
            <div className="md:w-[95%] pl-16 w-full md:text-base text-xs text-textcolor text-justify font-text pb-4">
              ...
              <p className="pb-2 font-bold">
                marketingdataconsultinglimited Ltd{' '}
              </p>
              <p className="mb-2">
                {' '}
                Choose marketingdataconsultinglimited Ltd. for a partnership
                that values commitment, collaboration, and innovation. Together,
                we can create a digital future that goes beyond the ordinary.
              </p>
        ...
        <div className="relative md:pb-0">
          <div className="w-full pb-4 text-xs text-justify md:text-base text-textcolor font-text">
            ...
            <div className="w-full pb-4 text-base text-justify text-textcolor font-text ">
              marketingdataconsultinglimited Pvt Ltd is an award winning product
