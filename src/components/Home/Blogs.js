      ...
      <div className="px-5 container-ack md:px-0">
        ...
        <div className="grid items-center gap-8 md:grid-cols-2">
          ...
          <div>
            ...
            <div className="w-full pb-2 text-sm text-justify text-textcolor font-text line-clamp-3">
              <p className="truncate-text">{blogs[2]?.titleDescription}</p>
            </div>
            <div className="flex justify-between pb-5">
              <Link href="/best-influencer-marketing-agencies-in-UK-in-2025">
        ...
        <div className="items-center hidden gap-8 pt-10 md:grid md:grid-cols-2">
          <div>
            ...
            <div className="w-full pb-2 text-sm text-justify text-textcolor font-text line-clamp-3">
              <p className="truncate-text">{blogs[0]?.titleDescription}</p>
            </div>
            <div className="flex justify-between pb-5">
        ...
        <div className="grid items-center gap-8 pt-10 md:grid-cols-2 md:hidden">
          ...
          <div>
            ...
            <h2 className="py-2 text-lg font-bold text-left text-secondary">
              Custom project management in agile -
              marketingdataconsultinglimited is different, just like everybody
              else
            </h2>
        ...
        <div className="grid items-center gap-8 pt-10 pb-16 md:grid-cols-2">
          ...
          <div>
            ...
            <div className="w-full pb-2 text-sm text-justify text-textcolor font-text">
              <p className="truncate-text">{blogs[1]?.titleDescription}</p>
            </div>
            <div className="flex justify-between pb-5">
              <Link href="/how-to-take-your-SEO-to-the-next-level-in-2025">
                <button className="py-2 text-sm text-black border-b-2 border-primary">
                  Read More
                </button>
              </Link>
