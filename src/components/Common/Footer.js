              ...
              <Link href="/">
                <div>
                  {/* <img
                                        ...
                                        className="w-48"
                                    /> */}
                  <p className="text-4xl font-bold">Marketing Afterdark Ltd</p>
                </div>
              </Link>
              <p className="text-sm text-justify">
                <strong>marketingdataconsultinglimited Ltd</strong> Is Your
                Partner in Building World-Class Products. We're empowering
                startups and enterprises of all shapes and sizes with modern
                tech-stack and smart frameworks to create rich and interactive
                experiences that captivates and engages new customers.
              </p>
              ...
              <div className="flex py-4 space-x-10">
                <ul className="">
                  <li className="cursor-pointer group">
                    <p className="py-2"> UK Locations : </p>
                    <span className="flex items-center space-x-2">
                      <GoLocation
                        size={24}
                        className="mt-3 text-black group-hover:text-primary"
                      />
                      <h2 className="text-sm md:w-[90%]">London</h2>
                    </span>
                  </li>
                  ...
                  <Link href="tel:+919910190071">
                    <li className="flex items-center pt-3 space-x-2 group">
                      <IoMdCall
                        ...
                        className="mt-3 text-black group-hover:text-primary"
                      />
                      <span className="text-sm">+44 7418 343383</span>
                    </li>
                  </Link>
          ...
          <div className="px-5 py-5 text-sm text-center md:px-0">
            <p>
              ...
              <span className="font-semibold">
                marketingdataconsultinglimited Innovation Ltd.
              </span>{' '}
              | All Rights Reserved
            </p>
          </div>
