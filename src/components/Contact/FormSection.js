          ...
          <div className="grid pl-16 justify-items items-center ">
            <div className="">
              <h1 className="font-extrabold text-3xl mb-5">
                marketingdataconsultinglimited, Across The Global Web
              </h1>
              <p>
                10,000+ pros, 3 yrs of awards. Our experts have tackled
                everything; from common roadblocks to industry-specific knots,
                paving the way for award-winning results for 3 years running.
                marketingdataconsultinglimited clients rave about the clarity,
                depth, and actionable insights that unlock their full potential.
                Ready? Let's talk!
              </p>
              ...
              <Link href="tel:+919910190071">
                <div className="flex space-x-2 mb-2 ">
                  <BiPhoneCall size={25} />
                  <p className="text-primary mb-2">+44 7418 343383</p>
                </div>
              </Link>
              <div className="flex space-x-2 cursor-pointer ">
                <GrMapLocation size={25} className="fill-orange" />
                <p className="text-primary ">
                  101 New Cavendish Street, 1st Floor South, London, United
                  Kingdom, W1W 6XH{' '}
                </p>
              </div>
            </div>
